...
X_test_hog = []
X_test_hog_features = []
for image_train in tqdm(X_train):
...
print(f'Accuracy test: {100*accuracy_test:.2f}')

print(grid.best_params_)

#save accuracy and best params
with open('hogsvm.txt', 'a') as f:
    f.write(f'Accuracy train: {100*accuracy_train:.2f}\n')
    f.write(f'Accuracy test: {100*accuracy_test:.2f}\n')
